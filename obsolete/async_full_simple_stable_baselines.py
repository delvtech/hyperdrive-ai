...
from traiderdaive import AsyncFullHyperdriveEnv
...
def run_train():
    ...
    gym_config = AsyncFullHyperdriveEnv.Config()
    env = gym.make(id="traiderdaive/gym_async_full_hyperdrive_env", gym_config=gym_config)
